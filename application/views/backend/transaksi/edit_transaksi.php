                ...
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('transaksi/update') ?>">
                        <div class="form-group">
                            <input type="text" name="kode_transaksi" value="<?= $transaksi['kode_transaksi'];?>" class="form-control" placeholder="*Generate ototmatis" readonly>
                        </div>
                            ...
                            <select name="id_pelanggan" class="form-control" required>
                                <?php 
                                    foreach ($pelanggan as $pel) {
                                            if ($transaksi['id_pelanggan'] == $pel->id_pelanggan) {?>
                                                <option value="<?= $pel->id_pelanggan?>" selected><?= $pel->nama?></option>
                                            <?php } else {?>
                        ...
                        <div class="form-group">
                            <input type="number" name="bobot" id="bobot" class="form-control" value="<?= $transaksi['bobot'];?>" placeholder="Bobot" >
                        </div>

                        <div class="form-group">
                            <input type="number" name="total" id="total" class="form-control" value="<?= $transaksi['total'];?>" placeholder="Total" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            <a href="<?php echo base_url('transaksi/riwayat') ?>" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
