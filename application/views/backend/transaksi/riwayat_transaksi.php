...
<body>
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            if ($row->status == "Selesai") {?>
                                                <td>
                                                    <a href="<?php echo base_url('transaksi/detail/'.$row->kode_transaksi) ?>" class="btn btn-warning btn-sm">Detail</a>
                                                    <!--<a href="" class="btn btn-danger btn-sm" >Edit</a> -->
                                                </td> 
                                            <?php } else {?>
                                                <td>
                                                    <a href="<?php echo base_url('transaksi/detail/'.$row->kode_transaksi) ?>" class="btn btn-warning btn-sm">Detail</a>
                                                    <a href="<?php echo base_url('transaksi/edit_transaksi/'.$row->kode_transaksi) ?>" class="btn btn-danger btn-sm" >Edit</a>
                                                </td> 
                                            <?php }
                                        ?>  
                                    </tr>
    ...
    <script>
        $('.status').change(function(){
            var status = $(this).val();
            var kt = status.substr(0,12);
            var stt = status.substr(12,10);
